...
var app = (function () {
    ...
    /* src/views/Home.svelte generated by Svelte v3.53.1 */
    ...
    /* src/views/About.svelte generated by Svelte v3.53.1 */

    const file$4 = "src/views/About.svelte";
    ...
    /* src/views/Perfil.svelte generated by Svelte v3.53.1 */

    const { console: console_1 } = globals;
    const file$3 = "src/views/Perfil.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Perfil (ruta protegida)";
    			add_location(h1, file$3, 15, 8, 295);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Perfil> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ user, onMount, navigate, $user });
    	return [$user];
    }
    ...
    /* src/views/Login.svelte generated by Svelte v3.53.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 30, 4, 712);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Ingrese Email");
    			add_location(input0, file$2, 32, 8, 793);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Ingrese Contraseña");
    			add_location(input1, file$2, 33, 8, 868);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$2, 34, 8, 951);
    			add_location(form, file$2, 31, 4, 732);
    			add_location(div, file$2, 29, 0, 702);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*procesarFormulario*/ ctx[2]), false, true, false)
    				];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			button = element("button");
    			button.textContent = "Cerrar Sesiòn";
    			add_location(button, file$1, 13, 9, 292);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*cerrarSesion*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			nav = element("nav");
    			if_block.c();
    			add_location(nav, file$1, 10, 0, 219);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (24:2) <Route path="/perfil">
    function create_default_slot_2(ctx) {
    	let perfil;
    	let current;
    	perfil = new Perfil({ $$inline: true });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Hola Router";
    			t1 = space();
    			create_component(router.$$.fragment);
    			attr_dev(h1, "class", "svelte-50bpor");
    			add_location(h1, file, 10, 1, 322);
    			attr_dev(div, "class", "text-center pt-4");
    			add_location(div, file, 9, 0, 290);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
